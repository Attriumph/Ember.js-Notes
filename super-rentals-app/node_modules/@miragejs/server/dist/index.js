(function (global, factory) {
  ...
  (global = global || self, factory((global.MirageJS = global.MirageJS || {}, global.MirageJS.Server = {})));
  ...
  var IdentityManager = function () {
    ...
    _createClass(IdentityManager, [{
      ...
      value: function set(uniqueIdentifier) {
        ...
        if (isNumber$1(uniqueIdentifier) && +uniqueIdentifier >= this._nextId) {
    ...
    createClass(Inflector, [{
      ...
      value: function plural(rule, replacement) {
        if (typeof rule === "string") {
          remove$1(this.uncountables, rule);
        }

        remove$1(this.uncountables, replacement);
      ...
      value: function irregular(singular, plural) {
        remove$1(this.uncountables, singular);
        remove$1(this.uncountables, plural);
  ...
  function camelize$1(word) {
    var camelizedWord = camelize(underscore(word), false);

    return camelizedWord.split("/").map(lowerFirst).join("/");
  }
  ...
  function getParam(params, key) {
      ...
      if (!hasOwnProperty$o.call(params, key)) {
  ...
  var BelongsTo = function (_Association) {
    ...
    _createClass(BelongsTo, [{
      ...
      value: function getForeignKey() {
        return "".concat(camelize$1(this.key), "Id");
      }
    }, {
  ...
  var DbCollection = function () {
    ...
    _createClass(DbCollection, [{
      ...
      value: function _findRecord(id) {
        ...
        var _this$_records$filter = this._records.filter(function (obj) {
          return obj.id === id;
        }),
            _this$_records$filter2 = _slicedToArray(_this$_records$filter, 1),
            record = _this$_records$filter2[0];
  ...
  */
  function resolve$$1(object, label) {
    ...
    var promise = new Constructor(noop$1, label);
  ...
  function handleOwnThenable(promise, thenable) {
    if (thenable._state === FULFILLED) {
      ...
      subscribe(thenable, undefined, function (value) {
        ...
        return reject$1(promise, reason);
      });
    }
  }
  ...
  function then(onFulfillment, onRejection, label) {
    ...
    var child = new parent.constructor(noop$1, label);
  ...
  var Enumerator = function () {
    function Enumerator(Constructor, input, abortOnReject, label) {
      ...
      this.promise = new Constructor(noop$1, label);
  ...
  */
  function race(entries, label) {
    ...
    if (!Array.isArray(entries)) {
      reject$1(promise, new TypeError('Promise.race must be called with an array'));
      return promise;
    }
  ...
  */
  function reject$1$1(reason, label) {
    /*jshint validthis:true */
    var Constructor = this;
    var promise = new Constructor(noop$1, label);
    reject$1(promise, reason);
  ...
  */
  ...
  Promise$2.cast = resolve$$1; // deprecated
  Promise$2.all = all;
  Promise$2.race = race;
  Promise$2.resolve = resolve$$1;
  Promise$2.reject = reject$1$1;

  Promise$2.prototype._guidKey = guidKey;
  ...
  **/
  ...
  var AllSettled = function (_Enumerator) {
    _inherits$1(AllSettled, _Enumerator);

    function AllSettled(Constructor, entries, label) {
      return _possibleConstructorReturn$1(this, _Enumerator.call(this, Constructor, entries, false /* don't abort on reject */, label));
    }
  ...
  function _possibleConstructorReturn$1$1(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

  function _inherits$1$1(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

  var PromiseHash = function (_Enumerator) {
    _inherits$1$1(PromiseHash, _Enumerator);

    function PromiseHash(Constructor, object) {
      var abortOnReject = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
      var label = arguments[3];
      return _possibleConstructorReturn$1$1(this, _Enumerator.call(this, Constructor, object, abortOnReject, label));
    }
  ...
  var Collection = function () {
    ...
    _createClass(Collection, [{
      ...
      value: function remove(model) {
        var _this$models$filter = this.models.filter(function (m) {
          return m.toString() === model.toString();
        }),
            _this$models$filter2 = _slicedToArray(_this$models$filter, 1),
            match = _this$models$filter2[0];
  ...
  var HasMany = function (_Association) {
    ...
    _createClass(HasMany, [{
      ...
      key: "getForeignKey",
      value: function getForeignKey() {
        return "".concat(this._container.inflector.singularize(camelize$1(this.key)), "Ids");
      }
    }, {
      key: "addMethodsToModelClass",
      value: function addMethodsToModelClass(ModelClass, key) {
        ...
        modelPrototype["new".concat(capitalize$1(camelize$1(this._container.inflector.singularize(association.key))))] = function () {
          var modelName, attrs;
        ...
        modelPrototype["create".concat(capitalize$1(camelize$1(this._container.inflector.singularize(association.key))))] = function () {
          var modelName, attrs;
      ...
      key: "identifier",
      get: function get() {
        return "".concat(camelize$1(this._container.inflector.singularize(this.key)), "Ids");
      }
    }]);
  ...
  var BaseRouteHandler = function () {
    ...
    _createClass(BaseRouteHandler, [{
      ...
      value: function getModelClassFromPath(fullPath) {
        ...
        var modelName = dasherize$1(camelize$1(this._container.inflector.singularize(lastPath)));
        return modelName;
      }
    }, {
      ...
      value: function _getAttrsForRequest(request, modelName) {
        ...
        var attrs = {};
        assert(json.data && (json.data.attributes || json.data.type || json.data.relationships), "You're using a shorthand or #normalizedRequestAttrs, but your serializer's normalize function did not return a valid JSON:API document. https://www.ember-cli-mirage.com/docs/api/modules/ember-cli-mirage/serializer~Serializer#normalize");
        ...
        if (json.data.relationships) {
          Object.keys(json.data.relationships).forEach(function (relationshipName) {
            ...
            assert(association, "You're passing the relationship '".concat(relationshipName, "' to the '").concat(modelName, "' model via a ").concat(request.method, " to '").concat(request.url, "', but you did not define the '").concat(relationshipName, "' association on the '").concat(modelName, "' model. https://www.ember-cli-mirage.com/docs/api/modules/ember-cli-mirage/orm/associations/association~Association"));
  ...
  var GetShorthandRouteHandler = function (_BaseShorthandRouteHa) {
    ...
    _createClass(GetShorthandRouteHandler, [{
      ...
      value: function handleStringShorthand(request, modelClass) {
        ...
        assert(modelClass, "The route handler for ".concat(request.url, " is trying to access the ").concat(camelizedModelName, " model, but that model doesn't exist. Create it using 'ember g mirage-model ").concat(modelName, "'."));
    ...
    _createClass(RouteHandler, [{
      ...
      value: function _toMirageResponse(result) {
        ...
        return new Promise$2(function (resolve, reject) {
          Promise$2.resolve(result).then(function (response) {
    ...
    var Child = function (_Parent) {
      ...
      function Child() {
        ...
        if (protoProps && has(protoProps, "constructor")) {
          ...
          (_protoProps$construct = protoProps.constructor).call.apply(_protoProps$construct, [_assertThisInitialized(_this)].concat(args));
        }
    ...
    _createClass(Model, [{
      ...
      value: function _implicitInverseFor(association) {
        ...
        return values(associations).filter(function (candidate) {
          ...
          if (candidateMatches) {
            assert(!inverse, "The ".concat(_this.modelName, " model has multiple possible inverse associations for the ").concat(association.ownerModelName, ".").concat(association.key, " association."));
            inverse = candidate;
          }
      ...
      key: "_validateAttrs",
      value: function _validateAttrs(attrs) {
        var _this4 = this;

        Object.keys(attrs).filter(function (key) {
          return _this4.associationKeys.includes(key);
        }).forEach(function (key) {
          var value = attrs[key];

          var association = _this4.associationFor(key);
          ...
          if (association instanceof HasMany) {
            ...
            assert(isCollection || isArrayOfModels || isNull, "You're trying to create a ".concat(_this4.modelName, " model and you passed in \"").concat(value, "\" under the ").concat(key, " key, but that key is a HasMany relationship. You must pass in a Collection, PolymorphicCollection, array of Models, or null."));
          } else if (association instanceof BelongsTo) {
            assert(value instanceof Model || isNull, "You're trying to create a ".concat(_this4.modelName, " model and you passed in \"").concat(value, "\" under the ").concat(key, " key, but that key is a BelongsTo relationship. You must pass in a Model or null."));
          }
        });
        Object.keys(attrs).filter(function (key) {
          return _this4.associationIdKeys.includes(key);
        }).forEach(function (key) {
          var value = attrs[key];
          ...
          if (key.match(/Ids$/)) {
            ...
            var isNull = value === null;
            assert(isArray || isNull, "You're trying to create a ".concat(_this4.modelName, " model and you passed in \"").concat(value, "\" under the ").concat(key, " key, but that key is a foreign key for a HasMany relationship. You must pass in an array of ids or null."));
          }
        });
        Object.keys(attrs).filter(function (key) {
          var value = attrs[key];
          ...
          assert(_this4.associationKeys.indexOf(key) > -1, "You're trying to create a ".concat(_this4.modelName, " model and you passed in a ").concat(modelOrCollection.toString(), " under the ").concat(key, " key, but you haven't defined that key as an association on your model."));
        });
      }
    }, {
        ...
        if (Array.isArray(foreignKeys)) {
          ...
          if (association.isPolymorphic) {
            found = foreignKeys.map(function (_ref2) {
              var type = _ref2.type,
                  id = _ref2.id;
              return _this5._schema.db[_this5._schema.toInternalCollectionName(type)].find(id);
            });
            found = compact(found);
          } else {
        ...
        if (tempAssociation && associateIds) {
          ...
          if (association.isPolymorphic) {
            models = associateIds.map(function (_ref3) {
              var type = _ref3.type,
                  id = _ref3.id;
              return _this8._schema[_this8._schema.toCollectionName(type)].find(id);
            });
          } else {
          ...
          if (inverse instanceof BelongsTo) {
            ...
            if (inverse.isPolymorphic) {
              ...
              alreadyAssociatedWith = newIdsForInverse.some(function (key) {
                return key.type == _this11.modelName && key.id == ownerId;
              });
            } else {
              _newId = ownerId;
      ...
      value: function _syncTempAssociations(tempAssociate) {
        ...
        Object.keys(this._tempAssociations).forEach(function (key) {
          if (_this12._tempAssociations[key] && _this12._tempAssociations[key].toString() === tempAssociate.toString()) {
            _this12._tempAssociations[key] = tempAssociate;
          }
        });
      }
    }, {
  ...
  var Serializer = function () {
    function Serializer(registry, type) {
      ...
      this.type = type;
      this.request = request;
      this.attrs = this.attrs || undefined;
      this.include = this.include || [];
      this.root = this.root || undefined;
      this.embed = this.embed || undefined;
      this.serializeIds = this.serializeIds || undefined;
    }
    ...
    _createClass(Serializer, [{
      ...
      value: function getHashForIncludedResource(resource) {
        ...
        if (resource instanceof PolymorphicCollection) {
          ...
          hashWithRoot = isArray(hash) ? _defineProperty({}, rootKey, hash) : _defineProperty({}, rootKey, [hash]);
  ...
  var JSONAPISerializer = function (_Serializer) {
    ...
    function JSONAPISerializer() {
      ...
      _this.alwaysIncludeLinkageData = _this.alwaysIncludeLinkageData || undefined;
      return _this;
    }
    ...
    _createClass(JSONAPISerializer, [{
      ...
      value: function _relationshipIsIncludedForModel(relationshipKey, model) {
        if (this.hasQueryParamIncludes()) {
          ...
          return graphResource && graphResource.relationships && graphResource.relationships.hasOwnProperty(dasherize$1(relationshipKey));
        } else {
  ...
  var SerializerRegistry = function () {
    ...
    _createClass(SerializerRegistry, [{
      ...
      value: function serializerFor(type) {
        ...
        if (explicit) {
          assert(!!SerializerForResponse, "You passed in ".concat(type, " as an explicit serializer type but that serializer doesn't exist. Try running `ember g mirage-serializer ").concat(type, "`."));
        } else {
  ...
  var Schema = function () {
    ...
    _createClass(Schema, [{
      ...
      value: function registerModel(type, ModelClass) {
        ...
        var modelName = dasherize$1(camelizedModelName);
        ...
        ModelClass.prototype.associationKeys = [];
        ModelClass.prototype.associationIdKeys = [];
      ...
      value: function toInternalCollectionName(type) {
        return "_".concat(this.toCollectionName(type));
      }
    }, {
      key: "toModelName",
      value: function toModelName(type) {
        var modelName = dasherize$1(type);
        return this._container.inflector.singularize(modelName);
      }
    }, {
  ...
  function createPretender(server) {
    return new Pretender(function () {
      this.passthroughRequest = function (verb, path, request) {
        if (server.shouldLog()) {
          console.log("Passthrough request: ".concat(verb.toUpperCase(), " ").concat(request.url));
        }
      };
      ...
      this.unhandledRequest = function (verb, path) {
        path = decodeURI(path);
        assert("Your Ember app tried to ".concat(verb, " '").concat(path, "', but there was no route defined to handle this request. Define a route that matches this path in your mirage/config.js file. Did you forget to add your namespace?"));
      };
    }, {
  ...
  var defaultPassthroughs = ["http://localhost:0/chromecheckurl", "http://localhost:30820/socket.io"];
    ...
    _createClass(Server, [{
      ...
      value: function _mapAssociationsFromAttributes(modelName, attributes) {
        ...
        Object.keys(attributes || {}).filter(function (attr) {
          ...
          assert(association && association instanceof BelongsTo, "You're using the `association` factory helper on the '".concat(attr, "' attribute of your ").concat(modelName, " factory, but that attribute is not a `belongsTo` association. Read the Factories docs for more information: http://www.ember-cli-mirage.com/docs/v0.3.x/factories/#factories-and-relationships"));
  ...
  exports._utilsInflectorCamelize = camelize$1;
  exports._utilsInflectorCapitalize = capitalize$1;
  exports._utilsInflectorDasherize = dasherize$1;
